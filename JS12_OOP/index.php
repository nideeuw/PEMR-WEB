    ...
    <table class="table">
        ...
        <tbody>
            ...
            foreach ($tampil as $show) {
                ...
                echo "<td><a href='edit.php?id=" . $show['id'] . "' class='btn btn-primary btn-sm'>Edit</a> ";
                echo "<a href='index.php?action=delete&id=" . $show['id'] . "' class='btn btn-danger btn-sm'>Delete</a></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
